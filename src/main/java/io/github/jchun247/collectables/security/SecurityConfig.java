    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/collections/{collectionId}/cards/{collectionCardId}/transaction-history").permitAll()
                            ...
                            if (requestURI.startsWith("/api/cards") ||
                                ...
                                requestURI.startsWith("/api/users/provision") ||
                                    (HttpMethod.GET.matches(request.getMethod()) && (
                                            ...
                                            requestURI.matches("/api/collections/[^/]+/(?:cards(?:/[^/]+/transaction-history)?|value-history(?:/chart)?)")))) {
